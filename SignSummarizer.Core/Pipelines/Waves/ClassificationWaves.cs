...
public sealed class ModifierDetectionWave : ISignWave
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            return Task.FromResult(SignWaveResult.Success(resultData));
        }
        catch (Exception ex)
        {
...
public sealed class RagRetrievalWave : ISignWave
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            if (atom.PoseEmbedding == null) return SignWaveResult.Failure("No embedding available for RAG retrieval");
