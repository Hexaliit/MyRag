...
public interface ISignVectorStore
{
    ...
    Task<IList<SignMatch>> FindMatchesAsync(float[] embedding, int topK = 5, string? signerId = null,
        CancellationToken cancellationToken = default);

    Task<IList<SignMatch>> FindMatchesAsync(SignAtom atom, int topK = 5, string? signerId = null,
        CancellationToken cancellationToken = default);
