...
{
    [JsonPropertyName("data")] public List<GiphyGif> Data { get; set; } = new();

    [JsonPropertyName("pagination")] public GiphyPagination? Pagination { get; set; }

    [JsonPropertyName("meta")] public GiphyMeta? Meta { get; set; }
}
...
public sealed class GiphyGif
{
    ...
    [JsonPropertyName("bitly_url")] public string BitlyUrl { get; set; } = string.Empty;

    [JsonPropertyName("bitly_gif_url")] public string BitlyGifUrl { get; set; } = string.Empty;

    [JsonPropertyName("embed_url")] public string EmbedUrl { get; set; } = string.Empty;
    ...
    [JsonPropertyName("source_tld")] public string? SourceTld { get; set; }

    [JsonPropertyName("source_post_url")] public string? SourcePostUrl { get; set; }

    [JsonPropertyName("is_indexable")] public int IsIndexable { get; set; }

    [JsonPropertyName("is_sticker")] public int IsSticker { get; set; }

    [JsonPropertyName("import_datetime")] public DateTime ImportDateTime { get; set; }

    [JsonPropertyName("trending_datetime")]
    public string? TrendingDatetime { get; set; }

    [JsonPropertyName("images")] public GiphyImages Images { get; set; } = new();

    [JsonPropertyName("user")] public GiphyUser? User { get; set; }

    [JsonPropertyName("analytics_response_payload")]
    public string? AnalyticsResponsePayload { get; set; }

    [JsonPropertyName("analytics")] public GiphyAnalytics? Analytics { get; set; }
}

public sealed class GiphyImages
{
    [JsonPropertyName("original")] public GiphyImage Original { get; set; } = new();

    [JsonPropertyName("downsized")] public GiphyImage Downsized { get; set; } = new();

    [JsonPropertyName("fixed_height")] public GiphyImage FixedHeight { get; set; } = new();

    [JsonPropertyName("fixed_height_downsampled")]
    public GiphyImage FixedHeightDownsampled { get; set; } = new();

    [JsonPropertyName("fixed_width")] public GiphyImage FixedWidth { get; set; } = new();
    ...
    [JsonPropertyName("original_still")] public GiphyImage OriginalStill { get; set; } = new();

    [JsonPropertyName("downsized_still")] public GiphyImage DownsizedStill { get; set; } = new();
...
public sealed class GiphyImage
{
    ...
    [JsonPropertyName("mp4")] public string? Mp4 { get; set; }

    [JsonPropertyName("mp4_size")] public string? Mp4Size { get; set; }

    [JsonPropertyName("webp")] public string? Webp { get; set; }

    [JsonPropertyName("webp_size")] public string? WebpSize { get; set; }
...
{
    [JsonPropertyName("onload")] public Dictionary<string, string>? Onload { get; set; }

    [JsonPropertyName("onclick")] public Dictionary<string, string>? Onclick { get; set; }

    [JsonPropertyName("onsent")] public Dictionary<string, string>? Onsent { get; set; }
}
