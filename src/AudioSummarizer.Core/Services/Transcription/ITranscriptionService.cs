...
public interface ITranscriptionService
{
    ...
    Task<AudioTranscript> TranscribeAsync(string audioPath, string? language = null, CancellationToken cancellationToken = default);
...
public sealed class TranscriptSegment
{
    ...
    /// </summary>
    public string ToMarkdown() => $"[{Start:F1}s - {End:F1}s] {Text}";
