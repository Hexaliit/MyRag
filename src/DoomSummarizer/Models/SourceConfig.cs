...
public class SourceRoutingConfig
{
    ...
    public Dictionary<string, SourceDefinition> Sources { get; set; } = new();

    [YamlMember(Alias = "routing")]
    public Dictionary<string, RoutingRule> Routing { get; set; } = new();

    [YamlMember(Alias = "topic_keywords")]
    public Dictionary<string, List<string>> TopicKeywords { get; set; } = new();
}
...
public class RoutingRule
{
    ...
    [YamlMember(Alias = "bbc_category")]
    public string? BbcCategory { get; set; }
