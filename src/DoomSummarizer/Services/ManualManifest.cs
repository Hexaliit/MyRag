...
public sealed record ManualManifest
{
    ...
    [YamlMember(Alias = "seed_url")] public string SeedUrl { get; init; } = "";

    [YamlMember(Alias = "path_filter")] public string? PathFilter { get; init; }

    [YamlMember(Alias = "max_depth")] public int MaxDepth { get; init; } = 3;

    [YamlMember(Alias = "max_pages")] public int MaxPages { get; init; } = 50;
}