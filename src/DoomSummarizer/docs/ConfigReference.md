...
**Default blocked domains:** facebook.com, twitter.com, x.com, instagram.com, linkedin.com, youtube.com, tiktok.com, accounts.google.com, play.google.com, apps.apple.com

**Default blocked extensions:** .pdf, .zip, .tar, .gz, .exe, .dmg, .png, .jpg, .jpeg, .gif, .svg, .webp, .mp3, .mp4, .mov, .avi, .mkv
