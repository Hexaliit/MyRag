...
public static class SignalDescriptions
{
    private static readonly Dictionary<string, SignalDescription> Descriptions = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["ocr.markdown"] = new("OCR Markdown", "Structured OCR output in Markdown (tables, headings, lists)."),
        ...
        ["ocr.nanonets.markdown"] = new("Nanonets OCR Markdown", "Markdown OCR output from Nanonets OCR-s."),
        ["ocr.nanonets.text"] = new("Nanonets OCR Text", "Plain-text OCR output from Nanonets OCR-s."),
        ["ocr.olmocr2.markdown"] = new("OlmOCR-2 Markdown", "Markdown OCR output from OlmOCR-2."),
        ["ocr.olmocr2.text"] = new("OlmOCR-2 Text", "Plain-text OCR output from OlmOCR-2."),
        ...
        ["content.extracted_markdown"] = new("Extracted Markdown", "Structured OCR output stored as Markdown."),
