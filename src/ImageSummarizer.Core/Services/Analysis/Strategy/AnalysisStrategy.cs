...
public static class BuiltInStrategies
{
    ...
    public static AnalysisStrategy BookPageOCR => new()
    {
        ...
        Name = "Book Page OCR",
        Description =
            "High-resolution monochrome preprocessing for optimal text extraction from book pages and documents",
        TargetTypes = new List<string> { "document" },
        Goals = new List<string> { "ocr", "text_extraction" },
        Priority = 10,
        Steps = new List<PreprocessingStep>
        {
            new()
            {
                Id = "deskew",
                ...
                Type = "geometric",
                Parameters = new Dictionary<string, object> { { "max_angle", 45 } }
            },
            new()
            {
                Id = "binarize",
                ...
                Type = "color",
                Parameters = new Dictionary<string, object> { { "method", "adaptive" }, { "threshold", 128 } }
            },
            new()
            {
                Id = "upscale",
                ...
                Type = "resize",
                Parameters = new Dictionary<string, object> { { "scale_factor", 2.0 }, { "method", "lanczos" } }
            },
            new()
            {
                Id = "denoise",
                ...
                Type = "filter",
                Parameters = new Dictionary<string, object> { { "strength", "medium" } }
            }
        }
    };
    ...
    public static AnalysisStrategy ObjectRecognition => new()
    {
        ...
        TargetTypes = new List<string> { "photo", "unknown" },
        Goals = new List<string> { "object_detection", "caption" },
        Priority = 5,
        Steps = new List<PreprocessingStep>
        {
            new()
            {
                ...
                Type = "color",
                Parameters = new Dictionary<string, object> { { "method", "luminance" } }
            },
            new()
            {
                Id = "contrast_boost",
                ...
                Type = "filter",
                Parameters = new Dictionary<string, object> { { "amount", 1.5 } }
            },
            new()
            {
                Id = "edge_enhance",
                ...
                Type = "filter",
                Parameters = new Dictionary<string, object> { { "method", "unsharp_mask" } }
            }
        }
    };
    ...
    public static AnalysisStrategy GifTextExtraction => new()
    {
        ...
        TargetTypes = new List<string> { "gif" },
        Goals = new List<string> { "ocr", "text_extraction" },
        Priority = 15,
        Steps = new List<PreprocessingStep>
        {
            new()
            {
                ...
                Type = "temporal",
                Parameters = new Dictionary<string, object> { { "max_frames", 100 } }
            },
            new()
            {
                Id = "stabilization",
                ...
                Type = "temporal",
                Parameters = new Dictionary<string, object> { { "method", "optical_flow" } }
            },
            new()
            {
                Id = "temporal_voting",
                ...
                Parameters = new Dictionary<string, object>
                    { { "voting_method", "majority" }, { "min_confidence", 0.7 } }
            }
        }
    };
    ...
    public static AnalysisStrategy ScreenshotAnalysis => new()
    {
        ...
        TargetTypes = new List<string> { "screenshot" },
        Goals = new List<string> { "caption", "ocr", "ui_analysis" },
        Priority = 8,
        Steps = new List<PreprocessingStep>
        {
            new()
            {
                ...
                Type = "detection",
                Parameters = new Dictionary<string, object> { { "method", "mser" } }
            },
            new()
            {
                ...
                Type = "filter",
                Parameters = new Dictionary<string, object> { { "region_based", true } }
            }
        }
    };
    ...
    public static AnalysisStrategy DiagramAnalysis => new()
    {
        ...
        TargetTypes = new List<string> { "diagram" },
        Goals = new List<string> { "caption", "structure_extraction" },
        Priority = 12,
        Steps = new List<PreprocessingStep>
        {
            new()
            {
                ...
                Type = "color",
                Parameters = new Dictionary<string, object> { { "num_colors", 8 }, { "method", "kmeans" } }
            },
            new()
            {
                Id = "edge_detection",
                ...
                Type = "filter",
                Parameters = new Dictionary<string, object> { { "method", "canny" } }
            },
            new()
            {
                Id = "line_detection",
                ...
                Type = "detection",
                Parameters = new Dictionary<string, object> { { "method", "hough" } }
            }
        }
    };
