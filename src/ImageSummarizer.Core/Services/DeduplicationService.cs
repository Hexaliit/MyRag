...
public class DeduplicationService
{
        ...
        CancellationToken ct = default)
    {
        ...
        _logger.LogInformation(
            "Found {GroupCount} duplicate groups containing {DuplicateCount} duplicates, wasting {Space:N0} bytes",
        ...
        CancellationToken ct = default)
    {
        ...
        switch (action)
        {
            ...
            case DeduplicationAction.Move:
                ...
                if (!dryRun && !Directory.Exists(moveToDirectory)) Directory.CreateDirectory(moveToDirectory);
                ...
                foreach (var duplicate in group.Images.Skip(1))
                {
                    ...
                    {
                        File.Move(duplicate.FilePath, destPath, true);
