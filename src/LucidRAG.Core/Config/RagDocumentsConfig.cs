...
public class DemoModeConfig
{
    ...
    public string OffTopicMessage { get; set; } =
        "This demo answers questions about the indexed documents. Try asking about topics covered in the available content.";
}
...
public class PromptsConfig
{
    ...
    public Dictionary<string, string> SystemPrompts { get; set; } = new()
    {
        ...
        ["Technical"] =
            "You are a technical documentation expert. Provide precise, code-focused answers with examples.",
