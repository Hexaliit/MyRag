...
public class ApiKeyEntity
{
    ...
    /// <summary>
    ///     User-supplied LLM API key (encrypted). Removes model/length constraints when set.
    /// </summary>
    public string? CustomLlmApiKey { get; set; }

    /// <summary>
    ///     Provider for custom key: "anthropic", "openai", "ollama".
    /// </summary>
    public string? CustomLlmProvider { get; set; }

    /// <summary>
    ///     User's preferred response length: "concise" | "standard" | "detailed".
    /// </summary>
    public string? PreferredResponseLength { get; set; }
