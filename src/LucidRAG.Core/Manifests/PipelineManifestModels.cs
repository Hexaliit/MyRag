...
public sealed class PipelineManifest
{
    ...
    [YamlMember(Alias = "version")] public string Version { get; set; } = "1.0.0";

    [YamlMember(Alias = "priority")] public int Priority { get; set; } = 0;

    [YamlMember(Alias = "enabled")] public bool Enabled { get; set; } = true;

    [YamlMember(Alias = "tags")] public List<string> Tags { get; set; } = new();
...
public sealed class PipelineLane
{
    ...
    [YamlMember(Alias = "priority")] public int Priority { get; set; } = 100;
...
{
    [YamlMember(Alias = "total_timeout")] public string? TotalTimeout { get; set; }
...
{
    [YamlMember(Alias = "cache_hit")] public List<string> CacheHit { get; set; } = new();

    [YamlMember(Alias = "no_results")] public List<string> NoResults { get; set; } = new();

    [YamlMember(Alias = "allow")] public List<string> Allow { get; set; } = new();

    [YamlMember(Alias = "block")] public List<string> Block { get; set; } = new();
}
