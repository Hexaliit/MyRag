...
namespace LucidRAG.Migrations
{
    ...
    [Migration("20260212161116_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LucidRAG.Entities.ApiKeyEntity", b =>
                {
                    ...
                    b.Property<string>("CustomLlmApiKey")
                        .HasMaxLength(1024)
                        .HasColumnType("character varying(1024)");

                    b.Property<string>("CustomLlmProvider")
                        .HasMaxLength(32)
            ...
            modelBuilder.Entity("LucidRAG.Entities.DocumentGraphEdge", b =>
                {
                    b.Property<int>("CombinedMentionWeight")
                        .HasColumnType("integer");

                    b.Property<int>("SharedEntityCount")
                        .HasColumnType("integer");

                    b.PrimitiveCollection<string[]>("SharedEntityNames")
                        .IsRequired()
                        .HasColumnType("text[]");
                    ...
                    b.ToView("mv_document_graph", (string)null);
                });

            modelBuilder.Entity("LucidRAG.Entities.EntityCentrality", b =>
                {
                    ...
                    b.Property<int>("InDegree")
                        .HasColumnType("integer");

                    b.Property<int>("OutDegree")
                        .HasColumnType("integer");
                    ...
                    b.ToView("mv_entity_centrality", (string)null);
                });
            ...
            modelBuilder.Entity("LucidRAG.Entities.EntityRelationship", b =>
                {
                    ...
                    b.HasIndex("SourceEntityId", "RelationshipType");
            ...
            modelBuilder.Entity("LucidRAG.Entities.MessagingContextStateEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "Platform", "WorkspaceId", "ScopeType", "ScopeKey")
                        .IsUnique();

                    b.ToTable("messaging_context_states", (string)null);
                });

            modelBuilder.Entity("LucidRAG.Entities.MessagingInteractionFeedbackEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<double>("CompositeSentiment")
                        .HasColumnType("double precision");

                    b.Property<DateTimeOffset>("CreatedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("EmojiSignalsJson")
                        .IsRequired()
                        .HasColumnType("jsonb");
                    ...
                    b.Property<double>("QuerySentiment")
                        .HasColumnType("double precision");

                    b.Property<double?>("ReactionSentiment")
                        .HasColumnType("double precision");

                    b.Property<string>("ReactionSignalsJson")
                        .HasColumnType("jsonb");

                    b.Property<double>("ReplySentiment")
                        .HasColumnType("double precision");
                    ...
                    b.HasIndex("QueryHash", "CreatedAt");

                    b.HasIndex("TenantId", "Platform", "WorkspaceId", "CreatedAt");

                    b.ToTable("messaging_interaction_feedback", (string)null);
                });

            modelBuilder.Entity("LucidRAG.Entities.MessagingTenantConfigEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("AllowedChannelIdsJson")
                        .IsRequired()
                        .HasColumnType("jsonb");

                    b.Property<string>("AllowedCollectionIdsJson")
                        .IsRequired()
                        .HasColumnType("jsonb");
                    ...
                    b.Property<bool>("EnableSentimentLearning")
                        .HasColumnType("boolean");
                    ...
                    b.HasIndex("Platform", "WorkspaceId");

                    b.HasIndex("TenantId", "Platform")
                        .IsUnique();

                    b.ToTable("messaging_tenant_configs", (string)null);
                });
            ...
            modelBuilder.Entity("LucidRAG.Entities.ProcessingSignalEntity", b =>
                {
                    ...
                    b.HasIndex("CollectionId", "SignalType", "CreatedAt");
