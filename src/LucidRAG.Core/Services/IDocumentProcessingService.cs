...
{
    Task<Guid> QueueDocumentAsync(Stream fileStream, string filename, Guid? collectionId,
    ...
    Task<List<DocumentEntity>> GetDocumentsAsync(Guid? collectionId = null, bool readyOnly = false,
        CancellationToken ct = default);
