...
{
    Task<List<FolderEntity>> GetFoldersAsync(Guid collectionId, Guid? parentFolderId = null, CancellationToken ct = default);
    ...
    Task<FolderEntity> CreateFolderAsync(Guid collectionId, string name, Guid? parentFolderId = null, string? description = null, CancellationToken ct = default);
    Task<FolderEntity> RenameFolderAsync(Guid folderId, string newName, CancellationToken ct = default);
    Task<FolderEntity> UpdateFolderAsync(Guid folderId, string? name = null, string? description = null, int? sortOrder = null, CancellationToken ct = default);
