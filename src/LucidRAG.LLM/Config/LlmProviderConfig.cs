...
public class BackendConfig
{
    ...
    /// </summary>
    public LlmBackendType GetBackendType()
    {
    ...
    /// </summary>
    public EndpointSelectionStrategy GetSelectionStrategy()
    {
...
public class DefaultsConfig
{
    ...
    /// </summary>
    public string GetProviderForTier(ProviderTier tier)
    {
        return tier switch
        {
    ...
    /// </summary>
    public string GetProviderForTier(string tier)
    {
