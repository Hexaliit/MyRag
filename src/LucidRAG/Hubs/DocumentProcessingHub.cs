...
public interface IProcessingNotificationService
{
    ...
    Task NotifyDocumentCompleted(Guid documentId, string documentName, int segmentCount, int entityCount,
        int tableCount, Guid? collectionId);
...
public class ProcessingNotificationService(IHubContext<DocumentProcessingHub> hubContext)
    : IProcessingNotificationService
{
    ...
    public async Task NotifyDocumentProgress(Guid documentId, string documentName, float progress, string stage,
        Guid? collectionId)
    {
        var payload = new
        {
    ...
    public async Task NotifyDocumentCompleted(Guid documentId, string documentName, int segmentCount, int entityCount,
        int tableCount, Guid? collectionId)
    {
        var payload = new
        {
