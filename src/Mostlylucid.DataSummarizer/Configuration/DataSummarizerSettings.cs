...
public class ConsoleOutputSettings
{
    ...
    public bool ShowFocusFindings { get; set; }
...
public class OutputProfileConfig
{
    ...
    public static OutputProfileConfig Default => new()
    {
        ...
        Console = new ConsoleOutputSettings
        {
            ShowSummary = true,
        ...
        Json = new JsonOutputSettings { Enabled = false, Pretty = true },
        Markdown = new MarkdownOutputSettings { Enabled = true }
    };
    ...
    public static OutputProfileConfig Tool => new()
    {
        ...
        Json = new JsonOutputSettings { Enabled = true, Pretty = false, IncludeProfile = true, IncludeInsights = true },
        Markdown = new MarkdownOutputSettings { Enabled = false }
    };
    ...
    public static OutputProfileConfig Brief => new()
    {
        ...
        Json = new JsonOutputSettings { Enabled = false },
        Markdown = new MarkdownOutputSettings { Enabled = false }
    };
    ...
    public static OutputProfileConfig Detailed => new()
    {
        ...
        {
            Enabled = true, Pretty = true, IncludeProfile = true, IncludeInsights = true, IncludeAlerts = true,
            IncludeCorrelations = true
        },
        Markdown = new MarkdownOutputSettings { Enabled = true, IncludeCharts = true }
    };
