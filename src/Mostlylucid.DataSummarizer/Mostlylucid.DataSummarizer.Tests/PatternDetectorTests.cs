...
public class PatternDetectorTests
{
    ...
    public async Task DetectsEmailPattern()
    {
        ...
        for (var i = 0; i < 20; i++) sb.AppendLine($"user{i}@example.com");
    ...
    public async Task DetectsPhonePattern()
    {
        var sb = new StringBuilder();
        sb.AppendLine("Phone");
        for (var i = 0; i < 30; i++) sb.AppendLine($"+1-555-{100 + i:D3}-{1000 + i:D4}");
        var path = WriteTempCsv(sb.ToString());
        var svc = new DataSummarizerService();
    ...
    public async Task DetectsUrlPattern()
    {
        ...
        for (var i = 0; i < 20; i++) sb.AppendLine($"https://example{i}.com/path/{i}");
        var path = WriteTempCsv(sb.ToString());
        var svc = new DataSummarizerService();
    ...
    public async Task DetectsUuidPattern()
    {
        var sb = new StringBuilder();
        sb.AppendLine("Id");
        for (var i = 0; i < 20; i++) sb.AppendLine(Guid.NewGuid().ToString());
        var path = WriteTempCsv(sb.ToString());
        var svc = new DataSummarizerService();
    ...
    public async Task DetectsCreditCardPattern()
    {
        ...
        for (var i = 0; i < 20; i++) sb.AppendLine($"4{100 + i:D3}-{2000 + i:D4}-{3000 + i:D4}-{4000 + i:D4}");
        var path = WriteTempCsv(sb.ToString());
        var svc = new DataSummarizerService();
    ...
    public async Task DetectsIpAddressPattern()
    {
        ...
        for (var i = 0; i < 30; i++) sb.AppendLine($"192.168.{i % 255}.{(i + 1) % 255}");
        var path = WriteTempCsv(sb.ToString());
        var svc = new DataSummarizerService();
    ...
    public async Task DetectsZipCodePattern_AsNumeric()
    {
        ...
        for (var i = 0; i < 30; i++) sb.AppendLine($"{10000 + i}");
        var path = WriteTempCsv(sb.ToString());
        var svc = new DataSummarizerService();
    ...
    public async Task DetectsDatePattern()
    {
        var sb = new StringBuilder();
        sb.AppendLine("Date");
        for (var i = 1; i <= 30; i++) sb.AppendLine($"2024-{i % 12 + 1:D2}-{i % 28 + 1:D2}");
        var path = WriteTempCsv(sb.ToString());
        var svc = new DataSummarizerService();
    ...
    public async Task NoFalsePositivesForRandomText()
    {
        ...
        for (var i = 0; i < 50; i++) sb.AppendLine($"This is random text number {i} with no special patterns");
        var path = WriteTempCsv(sb.ToString());
        var svc = new DataSummarizerService();
    ...
    public async Task DetectsMultiplePatternsInColumn()
    {
        ...
        for (var i = 0; i < 30; i++) sb.AppendLine($"user{i}@domain{i % 5}.com");
        var path = WriteTempCsv(sb.ToString());
        var svc = new DataSummarizerService();
