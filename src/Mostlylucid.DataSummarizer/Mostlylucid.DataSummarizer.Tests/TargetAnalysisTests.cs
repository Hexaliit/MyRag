...
";
        ...
        try
        {
            var svc = new DataSummarizerService(false, null, vectorStorePath: null,
                profileOptions: new ProfileOptions { TargetColumn = "Exited" });
            ...
            Assert.True(report.Profile.Target!.FeatureEffects.Count > 0,
                $"Expected feature effects but got {report.Profile.Target?.FeatureEffects?.Count ?? 0}");
        }
        finally
        {
    ...
    public async Task BinaryTarget_IdentifiesNumericFeatureEffects()
    {
        ...
        for (var i = 0; i < 50; i++) sb.AppendLine($"{45 + i % 20},{50000 + i * 100},1");
        // Non-churned customers tend to be younger
        for (var i = 0; i < 100; i++) sb.AppendLine($"{25 + i % 15},{40000 + i * 100},0");

        var path = WriteTempCsv(sb.ToString());
        try
        {
            var svc = new DataSummarizerService(vectorStorePath: null,
                profileOptions: new ProfileOptions { TargetColumn = "Churned" });
    ...
    public async Task BinaryTarget_IdentifiesCategoricalFeatureEffects()
    {
        ...
        for (var i = 0; i < 30; i++) sb.AppendLine("France,Premium,1");
        for (var i = 0; i < 10; i++) sb.AppendLine("France,Basic,0");
        // Germany has lower churn
        for (var i = 0; i < 5; i++) sb.AppendLine("Germany,Premium,1");
        for (var i = 0; i < 55; i++) sb.AppendLine("Germany,Basic,0");
    ...
    public async Task BinaryTarget_HandlesImbalancedData()
    {
        ...
        for (var i = 0; i < 95; i++) sb.AppendLine($"{i},0");
        for (var i = 0; i < 5; i++) sb.AppendLine($"{100 + i},1");
    ...
    public async Task MulticlassTarget_ComputesDistribution()
    {
        ...
        for (var i = 0; i < 40; i++) sb.AppendLine($"{i},A");
        for (var i = 0; i < 30; i++) sb.AppendLine($"{i},B");
        for (var i = 0; i < 20; i++) sb.AppendLine($"{i},C");
        for (var i = 0; i < 10; i++) sb.AppendLine($"{i},D");
    ...
    public async Task MulticlassTarget_HandlesThreeClasses()
    {
        ...
        // Low scores -> Bronze
        for (var i = 0; i < 30; i++) sb.AppendLine($"{10 + i % 20},Bronze");
        // Medium scores -> Silver
        for (var i = 0; i < 30; i++) sb.AppendLine($"{40 + i % 20},Silver");
        // High scores -> Gold
        for (var i = 0; i < 30; i++) sb.AppendLine($"{70 + i % 20},Gold");
    ...
    public async Task TargetColumn_AllSameValue_HandlesGracefully()
    {
        var sb = new StringBuilder();
        sb.AppendLine("Feature,Target");
        for (var i = 0; i < 50; i++) sb.AppendLine($"{i},1"); // All same target value
    ...
    public async Task TargetColumn_WithNulls_HandlesGracefully()
    {
        var sb = new StringBuilder();
        sb.AppendLine("Feature,Target");
        for (var i = 0; i < 30; i++) sb.AppendLine($"{i},1");
        for (var i = 0; i < 30; i++) sb.AppendLine($"{i},0");
        for (var i = 0; i < 10; i++) sb.AppendLine($"{i},"); // Nulls in target
    ...
    public async Task TargetColumn_SingleFeature_WorksCorrectly()
    {
        ...
        for (var i = 0; i < 25; i++) sb.AppendLine($"{50 + i},1");
        for (var i = 0; i < 25; i++) sb.AppendLine($"{10 + i},0");
    ...
    public async Task TargetColumn_MixedFeatureTypes_HandlesAll()
    {
        ...
        for (var i = 0; i < 25; i++) sb.AppendLine($"{70 + i},Premium,2024-01-{i % 28 + 1:D2},1");
        for (var i = 0; i < 25; i++) sb.AppendLine($"{30 + i},Basic,2024-02-{i % 28 + 1:D2},0");
    ...
    private static string CreateBinaryTargetData(int rowCount, double positiveRate)
    {
        ...
        for (var i = 0; i < rowCount - positiveCount; i++)
        {
