...
public static class PositionWeights
{
    ...
    /// </summary>
    public static double GetIntroThreshold(ContentType contentType)
    {
        return contentType switch
        {
    ...
    /// </summary>
    public static double GetConclusionThreshold(ContentType contentType)
    {
        return contentType switch
        {
    ...
    int TotalChunks = 0)
{
    ...
    /// </summary>
    public DocumentChunk WithTotalChunks(int totalChunks)
    {
        return this with { TotalChunks = totalChunks };
    }
}
    ...
    List<string> Organizations)
{
    ...
    private static bool IsFuzzyMatch(string a, string b)
    {
        ...
        var titlesToStrip = new[]
            { "Mr.", "Mrs.", "Ms.", "Dr.", "Sir", "Lady", "Lord", "Miss", "Captain", "Major", "Colonel", "Inspector" };
        var cleanA = a;
        var cleanB = b;
