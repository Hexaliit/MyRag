...
{
    [YamlMember(Alias = "base")] public double Base { get; set; } = 1.0;

    [YamlMember(Alias = "high_confidence")]
    public double HighConfidence { get; set; } = 1.5;

    [YamlMember(Alias = "low_confidence")] public double LowConfidence { get; set; } = 0.5;
}

public class ConfidenceDefaults
{
    [YamlMember(Alias = "high")] public double High { get; set; } = 0.9;

    [YamlMember(Alias = "medium")] public double Medium { get; set; } = 0.7;

    [YamlMember(Alias = "low")] public double Low { get; set; } = 0.5;

    [YamlMember(Alias = "threshold")] public double Threshold { get; set; } = 0.5;
}
...
public class FeatureDefaults
{
    ...
    [YamlMember(Alias = "enable_cache")] public bool EnableCache { get; set; } = true;

    [YamlMember(Alias = "can_escalate")] public bool CanEscalate { get; set; } = true;

    [YamlMember(Alias = "parallel_pages")] public bool ParallelPages { get; set; } = false;
}