...
Book summarizer plugin for DoomSummarizer. Provides hierarchical document splitting and book type detection for
long-form documents.
...
- **Book Type Detection**: Signal-based classification (fiction, nonfiction, academic, technical, play, anthology,
  collection)
...
- [Mostlylucid.LucidRAG.DoomSummarizer.Core](https://www.nuget.org/packages/Mostlylucid.LucidRAG.DoomSummarizer.Core) -
  Plugin interfaces and document model
