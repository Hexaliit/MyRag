...
public class CommentEntity
{
    ...
    [NotMapped] public int CurrentDepth { get; set; } = 0;
    ...
    [Column("parent_comment_id")] public int? ParentCommentId { get; set; }
...
{
    [Column("ancestor_id")] public int AncestorId { get; set; }

    [Column("descendant_id")] public CommentEntity Ancestor { get; set; }

    [Column("descendant_id")] public int DescendantId { get; set; }
