...
public interface IVectorStore : IAsyncDisposable, IDisposable
{
    ...
    /// </summary>
    Task UpsertDocumentsAsync(string collectionName, IEnumerable<VectorDocument> documents,
    ...
    /// </summary>
    Task<List<VectorDocument>> GetAllDocumentsAsync(string collectionName, string? parentId = null,
        CancellationToken ct = default);
    ...
    /// </summary>
    Task<List<VectorSearchResult>> SearchAsync(string collectionName, VectorSearchQuery query,
        CancellationToken ct = default);
    ...
    /// </summary>
    Task<List<VectorSearchResult>> FindSimilarAsync(string collectionName, string documentId, int topK = 10,
        CancellationToken ct = default);
    ...
    /// </summary>
    Task<Dictionary<string, VectorDocument>> GetDocumentsByHashAsync(string collectionName,
    ...
    /// </summary>
    Task RemoveStaleDocumentsAsync(string collectionName, string parentId, IEnumerable<string> validHashes,
        CancellationToken ct = default);
    ...
    /// </summary>
    Task<CachedSummary?> GetCachedSummaryAsync(string collectionName, string documentId,
        CancellationToken ct = default);
